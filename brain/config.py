...
KGS = {
    ...
    'HowNet_S': os.path.join(FILE_DIR_PATH, 'kgs/HowNet_S.spo'),
    'CnDbpedia': os.path.join(FILE_DIR_PATH, 'kgs/CnDbpedia.spo'),
    'CnDbpedia2': os.path.join(FILE_DIR_PATH, 'kgs/CnDbpedia2.spo'),
    'Medical': os.path.join(FILE_DIR_PATH, 'kgs/Medical.spo'),
    'Vacant': os.path.join(FILE_DIR_PATH, 'kgs/Vacant.spo')
}
